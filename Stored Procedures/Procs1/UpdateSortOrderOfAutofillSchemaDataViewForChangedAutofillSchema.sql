...
CREATE procedure [dbo].[UpdateSortOrderOfAutofillSchemaDataViewForChangedAutofillSchema]
...
BEGIN  
	exec [UpdateSortOrderForChangedAutofillSchemaDataView] @DateBeforeParentUpdated, @pkAutopkAutofillSchema
FETCH NEXT FROM db_cursorOuter INTO  @pkAutopkAutofillSchema
END  
