CREATE TABLE [dbo].[CPImportFoodStamps] (
    [pkCPImportFoodStamps]    DECIMAL (18)  IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_CPImportFoodStamps] PRIMARY KEY CLUSTERED ([pkCPImportFoodStamps] ASC)
);


GO
CREATE NONCLUSTERED INDEX [idxBatch]
    ON [dbo].[CPImportFoodStamps]([fkCPImportBatch] ASC, [ProcessDate] ASC, [CaseHeadIndividualID] ASC, [ParticipantIndividualID] ASC) WITH (ALLOW_PAGE_LOCKS = OFF);
