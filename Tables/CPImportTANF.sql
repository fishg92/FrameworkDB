CREATE TABLE [dbo].[CPImportTANF] (
    [pkCPImportTANF]          DECIMAL (18)  IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_CPImportTANF] PRIMARY KEY CLUSTERED ([pkCPImportTANF] ASC)
);


GO
CREATE NONCLUSTERED INDEX [idxBatch]
    ON [dbo].[CPImportTANF]([fkCPImportBatch] ASC, [ProcessDate] ASC, [CaseHeadIndividualID] ASC, [ParticipantIndividualID] ASC) WITH (ALLOW_PAGE_LOCKS = OFF);
