CREATE TABLE [dbo].[CPImportCAPI] (
    [pkCPImportCAPI]          DECIMAL (18)  IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_CPImportCAPI] PRIMARY KEY CLUSTERED ([pkCPImportCAPI] ASC)
);


GO
CREATE NONCLUSTERED INDEX [idxBatch]
    ON [dbo].[CPImportCAPI]([fkCPImportBatch] ASC, [ProcessDate] ASC, [CaseHeadIndividualID] ASC, [ParticipantIndividualID] ASC) WITH (ALLOW_PAGE_LOCKS = OFF);
