CREATE TABLE [dbo].[CPImportMinorConsent] (
    [pkCPImportMinorConsent]  DECIMAL (18)  IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_CPImportMinorConsent] PRIMARY KEY CLUSTERED ([pkCPImportMinorConsent] ASC)
);


GO
CREATE NONCLUSTERED INDEX [idxBatch]
    ON [dbo].[CPImportMinorConsent]([fkCPImportBatch] ASC, [ProcessDate] ASC, [CaseHeadIndividualID] ASC, [ParticipantIndividualID] ASC) WITH (ALLOW_PAGE_LOCKS = OFF);
