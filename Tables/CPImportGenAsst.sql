CREATE TABLE [dbo].[CPImportGenAsst] (
    [pkCPImportGenAsst]       DECIMAL (18)  IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_CPImportGenAsst] PRIMARY KEY CLUSTERED ([pkCPImportGenAsst] ASC)
);


GO
CREATE NONCLUSTERED INDEX [idxBatch]
    ON [dbo].[CPImportGenAsst]([fkCPImportBatch] ASC, [ProcessDate] ASC, [CaseHeadIndividualID] ASC, [ParticipantIndividualID] ASC) WITH (ALLOW_PAGE_LOCKS = OFF);
